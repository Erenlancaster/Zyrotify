    ...
    internal class CheckerHelper
    {
        ...
        public static void UpdateTitle()
        {
            for (; ; )
            {
                ...
                Console.Title = string.Format("Zyrotify | Module: Playlist Follower | Checked {0} - Remaining {1} | Hits {2} - Fails {4} - CPM ", new object[]
                {
                        CheckerHelper.check,
                        CheckerHelper.total,
                        CheckerHelper.hits,
                ...
                Console.Write("] CPM : ");
                Console.ForegroundColor = ConsoleColor.Cyan;
                Console.Write(CheckerHelper.CPM * 60);
                Console.WriteLine("");
                ...
                Console.Write("] Error : ");
                Console.ForegroundColor = ConsoleColor.DarkYellow;
                Console.Write(CheckerHelper.err);
                Console.WriteLine("");
                ...
                Console.ForegroundColor = ConsoleColor.DarkMagenta;
                Console.Write(CheckerHelper.check); Console.Write(" / "); Console.Write(CheckerHelper.total);
                Console.WriteLine("");
                ...
                Console.ForegroundColor = ConsoleColor.Green;
                Console.WriteLine(CheckerHelper.hits);
                ...
                Console.Write("] BAN : ");
                Console.ForegroundColor = ConsoleColor.DarkRed;
                Console.WriteLine(CheckerHelper.free);
                ...
                Console.Write("] BADS : ");
                Console.ForegroundColor = ConsoleColor.DarkRed;
                Console.WriteLine(CheckerHelper.bad);
                ...
                try
                {
                    ...
                    using (HttpRequest req = new HttpRequest())
                    {
                        ...
                        try
                        {
                            ...
                            if (CheckerHelper.check >= CheckerHelper.total)
                            {
                                break;
                            }
                            ...
                            req.Put("https://api.spotify.com/v1/playlists/" + Program.alqwe + "/followers").ToString();
